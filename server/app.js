...
<<<<<<< HEAD
=======
const updateInfoRouter=require("./routes/updateInfoRouter/updateInfoRouter")
const projectRouter=require('./routes/projectRouter/projectRouter.js')
const depRouter=require('./routes/depRouter/depRouter.js')
const adminRouter=require('./routes/adminRouter/adminRouter.js')
>>>>>>> e00c4e0 (登录注册模块)
...
<<<<<<< HEAD
=======
app.use(updateInfoRouter.routes(),updateInfoRouter.allowedMethods())
app.use(projectRouter.routes(),projectRouter.allowedMethods())
app.use(depRouter.routes(),depRouter.allowedMethods())
